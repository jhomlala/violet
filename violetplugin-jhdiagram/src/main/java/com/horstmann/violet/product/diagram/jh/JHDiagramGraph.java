 ...
 */
public class JHDiagramGraph extends AbstractGraph
{
    ...
    static
    {
        ...
        JHEdge jhEdge = new JHEdge();
        jhEdge.setToolTip("JH TEST NODE");
        EDGE_PROTOTYPES.add(jhEdge);
        
        JHNode noteEdge2 = new JHNode(); 
        noteEdge2.setToolTip("JH TEST STATE");
        NODE_PROTOTYPES.add(noteEdge2);
    }
